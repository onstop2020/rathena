		...
		case RK_DRAGONBREATH_WATER:
			{
				...
				if(sd)
					damagevalue = damagevalue * (90 + 10 * cap_value(pc_checkskill(sd, RK_DRAGONTRAINING), 1, MAX_SKILL_LEVEL) + (cap_value(pc_checkskill(sd, DK_DRAGONIC_AURA), 1, MAX_SKILL_LEVEL) >= 1 ? (sstatus->pow / 4 + sstatus->patk / 2) : 0)) / 100;
