/*
 ...
 Source Schema         : raggar

 Target Server Type    : MySQL
 Target Server Version : 80021
 File Encoding         : 65001

 Date: 07/08/2022 17:52:10
*/
...
-- Records of login
-- ----------------------------
INSERT INTO `login` VALUES (1, 'raggarid', 'raggarpw', 'S', 'athena@athena.com', 0, 0, 0, 0, 0, NULL, '', NULL, 0, '', 0, 0, 0, NULL, 0);
...
CREATE TABLE `picklog`  (
  ...
  `time` datetime NOT NULL,
  `char_id` int NOT NULL DEFAULT 0,
  `type` enum('M','P','L','T','V','S','N','C','A','R','G','E','B','O','I','X','D','U','$','F','Y','Z','Q','H','J','W','0','1','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'P',
  `nameid` int UNSIGNED NOT NULL DEFAULT 0,
  `amount` int NOT NULL DEFAULT 1,
  `refine` tinyint UNSIGNED NOT NULL DEFAULT 0,
  `card0` int UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE `zenylog`  (
  ...
  `type` enum('T','V','P','M','S','N','D','C','A','E','I','B','K','J','X','0','2') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'S',
  `amount` int NOT NULL DEFAULT 0,
  `map` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `type`(`type`) USING BTREE
