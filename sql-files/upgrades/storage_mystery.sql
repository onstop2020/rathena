...
-- ----------------------------
-- Table structure for storage_mystery
-- ----------------------------
DROP TABLE IF EXISTS `storage_mystery`;
CREATE TABLE `storage_mystery`  (
...
) ENGINE = MyISAM AUTO_INCREMENT = 11007 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = FIXED;
